    ...
    <div className="w-full max-w-2xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="pt-4">
          {stripUrl ? (
            <img
              ...
              className="max-h-[72vh] w-auto max-w-full drop-shadow-[0_18px_30px_rgba(28,23,18,0.35)] animate-popin"
            />
          ) : (
            <div className="h-[64vh] flex items-center justify-center font-type text-sm text-walnut/60">
      ...
      <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
        <a
          ...
          download={`filmin-strip-${filter}.png`}
          aria-disabled={!stripUrl}
          className="font-type text-paper bg-curtain hover:bg-curtain-light border-2 border-walnut rounded-full px-8 py-3 shadow-ticket active:translate-y-1 active:shadow-none transition"
        >
          download as sticker (.png)
        </a>
        <button
          onClick={onRetake}
